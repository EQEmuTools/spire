...
import (
	"fmt"
	"github.com/EQEmuTools/spirererererererererere/internal/console"
...
func getCallerMeta() string {
	...
	for {
		...
		if strings.Contains(pkg, "(*") {
			...
			// extract type from github.com/EQEmuTools/spirererererererererere/internal/eqemuserver.(*QuestHotReloadWatcher)
